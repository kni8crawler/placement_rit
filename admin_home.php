...
<div class="row" style="margin-top: 20%; margin-bottom: 10%;">
  <div class="col-sm-6 col-lg-6">
      ...
      <a href="ajobs.php"><img class="card-img-top" src="images/jobs2.jpg" alt="Card image cap" style="height: 300px;  border-radius: 10%; box-shadow: 10px 10px 5px black; margin-bottom: 10px;width:500px;" ></a>
    
  </div>
  <div class="col-sm-6 col-lg-6">
    
      <a href="admin_home1.php"><img class="card-img-top" src="images/aca1.jpg" alt="Card image cap" style="height: 300px; border-radius: 10%; box-shadow: 10px 10px 5px black; margin-left:10px;width:500px;"></a>
...
<div class="row" style="">
  ...
  <div class="col-sm-6 col-lg-6">
      ...
      <a href="atest.php"><img class="card-img-top" src="images/test.jpg" alt="Card image cap" style="height: 300px;  border-radius: 10%; box-shadow: 10px 10px 5px black; margin-bottom: 10px;width:500px;" ></a>

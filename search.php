				...
				<form class="mdl-layout " action="search1_new.php" method="POST" name="myform">	
					...
					<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label  mdl-cell--middle" style="">
			  		...
			  		<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label  mdl-cell--middle">
					    		<label>Aggregate or SCGPA</label>
					    		<select onchange="yesnoCheck(this);" name="back" required>
							    <option value="">Select</option>
							    <option value="opn1" name="back">Aggregate</option>
							    <option value="opn2" name="back">SCGPA</option>
							    </select>

							    
			  		</div>
			  		<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label  mdl-cell--middle" style="display: none" id="scgpa">
				    		<label style="color: black;">SCGPA</label><br/>
				    		<label class="radio-inline" style="font-weight: bolder;">
							   <input type="radio" name="overall" value="^6.[0-9]|^7.[0-9]|^8.[0-9]|^9.[0-9]">6.0+
							</label>
							<label class="radio-inline" style="font-weight: bolder;">
							   <input type="radio" name="overall" value="^6.[5-9]|^7.[0-9]|^8.[0-9]|^9.[0-9]">6.5+
							</label>
			  	    			<label class="radio-inline" style="font-weight: bolder;">
							   <input type="radio" name="overall" value="^7.[0-9]|^8.[0-9]|^9.[0-9]">7.0+
							</label>
								<label class="radio-inline" style="font-weight: bolder;">
							   <input type="radio" name="overall" value="^7.[5-9]|^8.[0-9]|^9.[0-9]">7.5+
							</label>
								<label class="radio-inline" style="font-weight: bolder;">
							   <input type="radio" name="overall" value=".*" >No cutoff
							</label>
			  		</div>

			  		<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label  mdl-cell--middle" style="display: none" id="aggr">
				    		<label style="color: black;">B.E Aggregate %</label><br/>
				    		<label class="radio-inline" style="font-weight: bolder;">
							   <input type="radio" name="overall1" value="^6[0-9]|^7[0-9]|^8[0-9]">60+
							</label>
							<label class="radio-inline" style="font-weight: bolder;">
							   <input type="radio" name="overall1" value="^6[5-9]|^7[0-9]|^8[0-9]">65+
							</label>
			  	    			<label class="radio-inline" style="font-weight: bolder;">
							   <input type="radio" name="overall1" value="^7[0-9]|^8[0-9]">70+
							</label>
								<label class="radio-inline" style="font-weight: bolder;">
							   <input type="radio" name="overall1" value="^7[5-9]|^8[0-9]">75+
							</label>
								<label class="radio-inline" style="font-weight: bolder;">
							   <input type="radio" name="overall1" value=".*" >No cutoff
							</label>
			  		</div>
			  		...
			  		<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label  mdl-cell--middle" style="">
							...
							<label class="radio-inline" style="font-weight: bolder;">
							   <input type="radio" name="nob" value="[0 1]|0[0 1]" >1
							</label>
							<label class="radio-inline" style="font-weight: bolder;">
							   <input type="radio" name="nob" value="[0 1 2]|0[0 1 2]" >2
							</label>
							<label class="radio-inline" style="font-weight: bolder;">
							   <input type="radio" name="nob" value="[0 1 2 3]|0[0 1 2 3]" >3
							</label>
							<label class="radio-inline" style="font-weight: bolder;">
							   <input type="radio" name="nob" value="[0 1 2 3 4]|0[0 1 2 3 4]" >4
							</label>
			  		</div>
			  		...
			  		<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label  mdl-cell--middle" style="">
							...
							<label class="radio-inline" style="font-weight: bolder;">
							   <input type="radio" name="yop" value="2020">2020
							</label>							
			  		</div>
...
<script>
    function yesnoCheck(that) {
        if (that.value == "opn1") {
            document.getElementById("aggr").style.display = "block";
        } else if (that.value == "opn2") {
            document.getElementById("scgpa").style.display = "block";
        }
    }
</script>
 <script src="https://code.jquery.com/jquery-3.2.1.slim.min.js" integrity="sha384-KJ3o2DKtIkvYIK3UENzmM7KCkRr/rE9/Qpg6aAZGJwFDMVNA/GpGFF93hXpG5KkN" crossorigin="anonymous"></script>

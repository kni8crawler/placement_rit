...
<div class="content-grid mdl-grid mdl-layout mdl-js-layout">
    ...
    border-radius: 5%; ">
			...
			<div class="card-body" >
				...
				<form class="mdl-layout " action="search1.php" method="POST" name="myform">	
					...
					<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label  mdl-cell--middle" style="">
			  		...
			  		<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label  mdl-cell--middle" style="">
				    		...
				    		<label class="radio-inline" style="font-weight: bolder;">
							   <input type="radio" name="overall" value="^[6-9][0-9]|^100">60+
							</label>
							<label class="radio-inline" style="font-weight: bolder;">
							   <input type="radio" name="overall" value="^6[5-9]|^[7-9][0-9]|^100">65+
							</label>
			  	    			<label class="radio-inline" style="font-weight: bolder;">
							   <input type="radio" name="overall" value="^[7-9][0-9]|^100">70+
							</label>
								<label class="radio-inline" style="font-weight: bolder;">
							   <input type="radio" name="overall" value="^7[5-9]|^[8-9][0-9]|^100">75+
							</label>
								<label class="radio-inline" style="font-weight: bolder;">
							   <input type="radio" name="overall" value=".*" required>No cutoff
							</label>
			  		</div>

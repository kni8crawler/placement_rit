...
<?php
  ...
  if($_POST['reset']){
    ...
    $result = mysqli_query($db,$sql);
      ...
      if($count != 1) {
        $error = "USN does not exist!!!";
      }
      else{
      $sql = "UPDATE login SET pass='reset', first_time='NULL' WHERE usn = '$myusn'";
   	  $result = mysqli_query($db,$sql);
      if($result) 
      {   echo "<SCRIPT type='text/javascript'> //not showing me this
        alert('Passowrd Reset Successful!!!');
...
<body style="background: url(images/back1.png); background-size: cover; background-repeat:  no-repeat; background-attachment: fixed;" onload="blocking()">
    ...
    border-radius: 5%; ">
			...
			<div class="card-body" style="text-align: center; " >
					...
					<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label  mdl-cell--middle">
			  		...
			  		<br/>
			  		<input type="submit" value="Password Reset" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect  mdl-cell--middle"  style="font-family: 'Orbitron',sans-serif;font-weight: bold; color:white; background-color: #000000;margin-top:10px; border-radius: 10px;" id="submit" name="reset" >

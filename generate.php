    ...
    border-radius: 5%; ">
      ...
      <table align="center" cellspacing="5px">
        <tr>
          ...
          <th style="width:10%;border: 1px solid black;color: blue; text-align: center;">DATE</th>
        </tr>
      <?php
      for ($j = 0 ; $j < $rows; $j++)
      {
        ...
        echo "<td style='width:10%;border: 1px solid black;color: blue; text-align: center;'>".$row['date']."</td>";
        echo "</tr>";
      }
      ?>
      </table>

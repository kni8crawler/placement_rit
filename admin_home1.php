...
<div class="row" style="margin-top: 20%;">
  <div class="col-sm-6 col-lg-6">
      ...
      <a href="edit.php"><img class="card-img-top" src="images/edit.bmp" alt="Card image cap" style="height: 300px;  border-radius: 10%; box-shadow: 10px 10px 5px black; margin-bottom: 10px;width:500px;" ></a>
    
  </div>
  <div class="col-sm-6 col-lg-6">
    
      <a href="search.php"><img class="card-img-top" src="images/search.jpg" alt="Card image cap" style="height: 300px; border-radius: 10%; box-shadow: 10px 10px 5px black; margin-left:10px;width:500px;"></a>
...
<div class="row" style="margin-top: 5%; margin-bottom: 20%;">
  ...
  <div class="col-sm-6 col-lg-6">
      ...
      <a href="delete.php"><img class="card-img-top" src="images/delete.jpg" alt="Card image cap" style="height: 300px;  border-radius: 10%; box-shadow: 10px 10px 5px black; margin-bottom: 10px;width:500px;" ></a>

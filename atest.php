...
<?php
   ...
   if($requestMethod == "POST") {
      ...
      $test_id = mysqli_real_escape_string($db,$_POST['test_id']);
      $link = mysqli_real_escape_string($db,$_POST['link']);
      $sql1 = "INSERT INTO test (test_id, name, link) VALUES ('$test_id','$name', '$link')";
...
<div class="content-grid mdl-grid mdl-layout mdl-js-layout">
	 <div class="mdl-cell"></div>
	  <div class="mdl-cell" >
      <div>
    <form method="get" action="atest1.php">
    <input type="submit" value="Delete Test" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect  mdl-cell--middle"  style=" margin-left:35%; font-family: 'Orbitron',sans-serif;font-weight: bold; color:white; background-color: #000000;margin-top:10px; border-radius: 10px;" id="submit" name="submit" >
   </form></div>
    ...
    border-radius: 5%; ">
			...
			<div class="card-body" >
				<form class="mdl-layout " action="" method="POST" name="myform">	
					...
					<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label  mdl-cell--middle" style="">
				    		<input class="mdl-textfield__input" type="text" id="test_id" name="test_id">
				    		<label class="mdl-textfield__label" for="test_id" style="color: black;">Test ID</label>
			  		</div>
          ...
          <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label  mdl-cell--middle" style="">
            ...
            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label  mdl-cell--middle" style="">
                <input class="mdl-textfield__input" type="text" id="link" name="link">
                <label class="mdl-textfield__label" for="link" style="color: black;">Website(Don't include http://)</label>
            </div>
...
<form class="mdl-layout " action="generate.php" method="POST" name="myform">          
<input type="submit" value="Generate Report" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect  mdl-cell--middle"  style="font-family: 'Orbitron',sans-serif;font-weight: bold; color:white; background-color: #000000;margin-top:10px; border-radius: 10px;" id="submit" name="submit" >  
        </form> 
			</div>
		</div>
  </div>	

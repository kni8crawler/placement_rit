...
<?php
   ...
   if($requestMethod == "POST") {
      ...
      $id = mysqli_real_escape_string($db,$_POST['id']);
        $sql3 = "DELETE FROM test WHERE test_id = '$id'";
...
<div class="content-grid mdl-grid mdl-layout mdl-js-layout">
    ...
    border-radius: 5%; ">
			...
			<div class="card-body" >
                ...
                <label class="mdl-textfield__label" for="id" style="color: black;">TEST ID</label>
            </div>	
					
			  		<div style = "font-size:20px; color:#cc0000; margin-top:10px"><?php echo $error; ?></div>
					<input type="submit" value="Test Over" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect  mdl-cell--middle"  style="font-family: 'Orbitron',sans-serif;font-weight: bold; color:white; background-color: #000000;margin-top:10px; border-radius: 10px;" id="submit" name="submit" >	
				</form> 
      </div>
		</div>
  </div>	

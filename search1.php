...
<?php
   include("dbconfig.php");
      ...
      $sql = "SELECT r.name, r.usn, r.email, r.mno, r.sslc, r.pudip, b.branch, b.overall, b.nob, b.yop, b.branch FROM records r, be_data b WHERE r.usn = b.usn AND r.sslc REGEXP '$sslc' AND r.pudip REGEXP '$pudip' AND b.overall REGEXP '$overall' AND b.nob REGEXP '$nob' AND b.yop REGEXP '$yop' AND b.branch REGEXP '$branch'";

      $result = mysqli_query($db,$sql);
      $rows = mysqli_num_rows($result); 
      $sql1 = "SELECT s.sem1o, s.sem2o, s.sem3o, s.sem4o, s.sem5o, s.sem6o, s.sem7o, s.sem8o FROM sem_marks s, be_data b, records r WHERE s.usn = b.usn AND r.sslc REGEXP '$sslc' AND r.pudip REGEXP '$pudip' AND b.overall REGEXP '$overall' AND b.nob REGEXP '$nob' AND b.yop REGEXP '$yop' AND b.branch REGEXP '$branch'";
    ...
    border-radius: 5%; ">
      ...
      <table align="center" cellspacing="5px">
        <tr>
          ...
          <th style="border: 1px solid black;color: blue; text-align: center;">B.E AGGREGATE</th>
          ...
          <th style="border: 1px solid black;color: blue; text-align: center;">Sem 1 (775)</th>
                    <th style="border: 1px solid black;color: blue; text-align: center;">Sem 2 (775)</th>
                              <th style="border: 1px solid black;color: blue; text-align: center;">Sem 3 (900)</th>
                                        <th style="border: 1px solid black;color: blue; text-align: center;">Sem 4 (900)</th>
                                                  <th style="border: 1px solid black;color: blue; text-align: center;">Sem 5 (900)</th>
                                                            <th style="border: 1px solid black;color: blue; text-align: center;">Sem 6 (900)</th>
                                                                      <th style="border: 1px solid black;color: blue; text-align: center;">Sem 7 (900)</th>
                                                                                <th style="border: 1px solid black;color: blue; text-align: center;">Sem 8 (750)</th>
        </tr>
      <?php
      for ($j = 0 ; $j < $rows; $j++)
      {
        ...
        echo "<td style='width:10%;border: 1px solid black;color: blue; text-align: center;'>".$row['yop']."</td>";
                echo "<td style='width:10%;border: 1px solid black;color: blue; text-align: center;'>".$row1['sem1o']."</td>";
                        echo "<td style='width:10%;border: 1px solid black;color: blue; text-align: center;'>".$row1['sem2o']."</td>";
                                echo "<td style='width:10%;border: 1px solid black;color: blue; text-align: center;'>".$row1['sem3o']."</td>";
                                        echo "<td style='width:10%;border: 1px solid black;color: blue; text-align: center;'>".$row1['sem4o']."</td>";
                                                echo "<td style='width:10%;border: 1px solid black;color: blue; text-align: center;'>".$row1['sem5o']."</td>";
                                                        echo "<td style='width:10%;border: 1px solid black;color: blue; text-align: center;'>".$row1['sem6o']."</td>";
                                                                echo "<td style='width:10%;border: 1px solid black;color: blue; text-align: center;'>".$row1['sem7o']."</td>";
                                                                        echo "<td style='width:10%;border: 1px solid black;color: blue; text-align: center;'>".$row1['sem8o']."</td>";
        echo "</tr>";

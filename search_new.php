			...
			<div class="card-body" >
				...
				<form class="mdl-layout " action="search1_new.php" method="POST" name="myform">	
					...
					<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label  mdl-cell--middle" style="">
			  		...
			  		<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label  mdl-cell--middle" style="">
				    		<label style="color: black;">B.E Aggregate (SCGPA)</label><br/>
				    		<label class="radio-inline" style="font-weight: bolder;">
							   <input type="radio" name="overall" value="^[5-9]|10">5+
							</label>
							<label class="radio-inline" style="font-weight: bolder;">
							   <input type="radio" name="overall" value="^[6-9]|10">6+
							</label>
			  	    			<label class="radio-inline" style="font-weight: bolder;">
							   <input type="radio" name="overall" value="^[7-9]|100">7+
							</label>
								<label class="radio-inline" style="font-weight: bolder;">
							   <input type="radio" name="overall" value="^[8-9]|10">8+
							</label>
								<label class="radio-inline" style="font-weight: bolder;">
							   <input type="radio" name="overall" value="^9|10">9+
							</label>
								<label class="radio-inline" style="font-weight: bolder;">

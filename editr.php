...
if($count != 1) 
   ...
   $sql1 = "SELECT * FROM records WHERE usn = '$usn' ";
    $result1 = mysqli_query($db,$sql1);
    $row1 = mysqli_fetch_array($result1,MYSQLI_ASSOC); 
    $name = $row1["name"];
    $usn = $row1["usn"];
    $_SESSION['usnn'] = $usn;
    header("location: editr1_new.php?usn=$usn");
    }
  } 
?>
<html>
    ...
    border-radius: 5%; ">
            ...
            <form class="mdl-layout " action="" method="POST" name="myform" id="formid" style="text-align: center; font-weight: bolder;">
					   <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label  mdl-cell--middle">
			  		    ...
			  		    <input type="submit" value="search" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect  mdl-cell--middle"  style="font-family: 'Orbitron',sans-serif;font-weight: bold; color:white; background-color: #000000;margin-top:10px; border-radius: 10px;" id="submit" name="search" >
